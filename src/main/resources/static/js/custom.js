...
function add(type) {
	...
	var inputVal = jQuery(type).val();

	var sum = parseInt(inputVal) + 1;
...
function sendAllData() {
	...
	window.location.replace("order_summary.html?date=" + params.get('date') + "&time=" + params.get('time') + "&adult=" + adult + "&ch=" + ch + "&old=" + old);
...
function checkOut() {
	...
	window.location.replace("Checkout.html?date=" + params.get('date') + "&time=" + params.get('time') + "&adult=" + params.get('adult') + "&ch=" + params.get('ch') + "&old=" + params.get('old'));
...
function Booked() {
	...
	window.location.replace("booked.html?date=" + params.get('date') + "&time=" + params.get('time') + "&adult=" + params.get('adult') + "&ch=" + params.get('ch') + "&old=" + params.get('old') + "&name=" + name);
...
function sendData() {
	...
	window.location.replace("seats.html?date=" + date + "&time=" + time);

	//jQuery.load("userprofile.html",function(){
...
$("#order").ready(function () {
	...
	var total = parseInt(params.get('ch')) + parseInt(params.get('adult')) + parseInt(params.get('old'));
	var bill = 300 * total;


	jQuery("#datetime").text("Date & time : " + params.get('date') + " - " + params.get('time'));
	jQuery("#ch").text("Childerns: " + params.get('ch'));
	jQuery("#adult").text("Adults : " + params.get('adult'));
	jQuery("#old").text("Old: " + params.get('old'));
	jQuery("#fee").text("Total Bill: " + bill);
	jQuery("#seats").text("Total Tickets: " + total);
...
$("#booking").ready(function () {
	...
	jQuery("#message").text("Congratulations!! MR." + params.get('name') + " Your booking is confirmed on " + params.get('date') + " - " + params.get('time'));
...
$("#fee").ready(function () {
	...
	jQuery("#bill").text("Total Bill: " + bill);
